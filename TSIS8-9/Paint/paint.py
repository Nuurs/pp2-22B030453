...
while living:
    ...
    while welcomepage:
        ...
        for event in pygame.event.get():
            ...
            screen.blit(welcomeFont2.render("S-Save Image", True, (0, 0, 0)), (10, 350))
            #screen.blit(welcomeFont2.render("S-Save Image",True,(0,255,0)),(100,325))
    ...
    if pressedkey[K_d]:
        ...
        pygame.image.save(background, './img/{}.png'.format(a))
    elif pressedkey[K_l]:
        path = './img/' 
    ...
    # background.blit(surffont2.render("Using color: %s"%colornacdme, True, color), (550, 550))
    screen.blit(forbutton, (1, 1))
